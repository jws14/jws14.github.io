...
```{r}
#Within the dataset we chose to examine the impact that 
```

# Data
```{r}
Earthquake <-read_csv('/Users/jeremysun/Documents/Important/Data Analytics 200/Project/jws14.github.io/project_files/earthquakedata.csv')
```
